---
approved_by: human
approved_at: 2026-07-13T20:53:24.400Z
...
iron_loop: true
approved_by: human
approved_at: 2026-07-13T19:14:57.834Z
...
- [x] **Scenario: All 16 step agents resolve**
...
- [x] **Scenario: Registry has no dangling paths**
...
- [x] **Scenario: Every cto-chief dispatch target resolves**
...
- [x] **Scenario: No Tier-1→Tier-1 peer dispatch remains**
...
- [x] **Scenario: Resolution test proves it catches the defect (red before fix)**
...
- [x] **Scenario: Resolution test passes after the fix**
...
- [x] **Scenario: Regression protection for future additions**
...
- [x] **Scenario: Registry drift after regeneration is still caught**
...
- [x] **Scenario: All 10 new step agents exist with valid contracts**
...
- [x] **Scenario: Step table, registry, and coordinator repointed to real executors**
