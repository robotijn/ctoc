---
approved_by: human
approved_at: 2026-07-13T20:53:24.799Z
...
iron_loop: true
approved_by: human
approved_at: 2026-07-13T19:14:57.887Z
...
- [x] **Scenario: Deleted module fails loud, not quiet**
...
- [x] **Scenario: Present module leaves the suite unaffected**
...
- [x] **Scenario: Any skip fails the gate**
...
- [x] **Scenario: Coverage is measured and reported as a real number**
...
- [x] **Scenario: Coverage below 80% fails the gate**
...
- [x] **Scenario: Dangling registry path fails, naming the path**
...
- [x] **Scenario: Unresolvable step-table agent fails, naming the step**
...
- [x] **Scenario: Version disagreement fails, naming every mismatched file**
...
- [x] **Scenario: License disagreement fails**
...
- [x] **Scenario: Stale documented count fails**
...
- [x] **Scenario: Missing installer-written path fails**
...
- [x] **Scenario: Release test guards the real artifact, not a duplicate**
...
- [x] **Scenario: Paired-fix lifecycle holds for every invariant above**
