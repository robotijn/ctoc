---
approved_by: human
approved_at: 2026-07-13T20:53:24.961Z
...
iron_loop: true
approved_by: human
approved_at: 2026-07-13T19:14:57.968Z
...
- [x] **Scenario: package.json version syncs with release**
...
- [x] **Scenario: package.json license matches LICENSE**
...
- [x] **Scenario: version/license single-source invariant test**
...
- [x] **Scenario: mutating one version value fails the invariant test**
...
- [x] **Scenario: release fails loudly on a partial sync failure**
...
- [x] **Scenario: release succeeds cleanly reports exit 0**
  Given all JSON version-file writes succeed during a `release.js` run
  When the run completes
  Then the process exits 0

- [x] **Scenario: atomic write survives a simulated mid-write crash**
...
- [x] **Scenario: update aborts on an unparseable plugin registry**
...
- [x] **Scenario: other plugins survive an update after a registry parse failure**
...
- [x] **Scenario: a valid, parseable registry is updated normally**
