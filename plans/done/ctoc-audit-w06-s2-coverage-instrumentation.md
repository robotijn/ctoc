---
approved_by: human
approved_at: 2026-07-13T20:53:24.657Z
...
iron_loop: true
approved_by: human
approved_at: 2026-07-13T19:14:43.392Z
...
- [x] `src/scripts/test-gate.js` — pure parsers + `evaluateSummary` + CLI spawn/exit
- [x] `package.json` — route `scripts.test` through the gate; add `scripts.test:raw`
