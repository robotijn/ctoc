---
approved_by: human
approved_at: 2026-07-13T20:53:24.634Z
...
- [x] `tests/add-exploration-template.test.js` — hoist hard require, delete null-guard skips
- [x] `tests/consensus-resolver.test.js` — hoist hard require, delete null-guard skips
- [x] `tests/deep-explorer.test.js` — hoist hard require, delete null-guard skips
- [x] `tests/governance-modules-b.test.js` — hoist hard require, delete null-guard skips
- [x] `tests/lib-utils-batch.test.js` — hoist hard require, delete null-guard skips
- [x] `tests/plan-index-embedding.test.js` — hoist hard require, delete null-guard skips
- [x] `tests/review-reporter.test.js` — hoist hard require, delete null-guard skips
- [x] `tests/strategic-classifier.test.js` — hoist hard require, delete null-guard skips
