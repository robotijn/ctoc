---
approved_by: human
approved_at: 2026-07-13T20:53:24.730Z
...
iron_loop: true
approved_by: human
approved_at: 2026-07-13T19:14:43.470Z
...
- [x] `tests/helpers/source-of-truth.js` — `readVersionSources`, `readLicenseSources`,
  `allVersionsAgree`
- [x] `tests/release.test.js` — add the real-artifact `describe` block using the helper;
