---
approved_by: human
approved_at: 2026-07-13T20:53:24.008Z
...
iron_loop: true
approved_by: human
approved_at: 2026-07-13T19:14:57.735Z
...
- [x] **Scenario: Uncovered Edit is actually prevented**
...
- [x] **Scenario: Uncovered Write is prevented via the delegate path**
...
- [x] **Scenario: MultiEdit is blocked exactly like a single Edit**
...
- [x] **Scenario: NotebookEdit is blocked exactly like a single Edit**
...
- [x] **Scenario: Bash gate reads the real transport for a destructive command**
...
- [x] **Scenario: Bash gate does not fall through to allow-by-default**
...
- [x] **Scenario: enforce() fires from a sibling entry point**
...
- [x] **Scenario: Uniform protocol across all five surfaces**
...
- [x] **Scenario: Plan-covered edit is still allowed**
...
- [x] **Scenario: Escape phrase still allows after the protocol change**
