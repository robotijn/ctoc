---
approved_by: human
approved_at: 2026-07-13T20:53:24.126Z
...
iron_loop: true
approved_by: human
approved_at: 2026-07-13T19:14:57.780Z
...
- [x] **[C4] Scenario: Self-authored marker without ledger entry is not accepted**
...
- [x] **[C4] Scenario: Ledger-approved plan is accepted**
...
- [x] **[C4] Scenario: Approval invalidated by post-approval edit**
...
- [x] **[C4] Scenario: Ledger path is agent-write-denied**
...
- [x] **[H2] Scenario: Multi-hop move across one gate is blocked**
...
- [x] **[H2] Scenario: Multi-hop move across two gates is blocked**
...
- [x] **[H2] Scenario: Legitimate non-gate move still succeeds**
...
- [x] **[C5] Scenario: Revert sweep survives a mid-loop filesystem failure**
...
- [x] **[H7] Scenario: Fresh SIP1 slice is exempt from residency revert**
...
- [x] **[H7] Scenario: Illegally-placed plan without SIP1 provenance is still reverted**
...
- [x] **[M18] Scenario: Crash between stamp and move never leaves a false-approved plan in the source folder**
...
- [x] **[M19] Scenario: Frontmatter parses correctly after a marker prepend**
