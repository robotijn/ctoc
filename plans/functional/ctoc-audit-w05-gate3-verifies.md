...
- [ ] **Scenario: Rejects a plan missing the human-approval marker**
...
- [ ] **Scenario: Rejects a plan with an unchecked Step 14 VERIFY checkbox**
...
- [ ] **Scenario: Accepts a genuinely finished plan**
...
- [ ] **Scenario: A failed real verification run blocks the transition**
...
- [ ] **Scenario: Stale-cleanup path is validated identically to the manual path**
...
- [ ] **Scenario: Post-push sync path is validated identically to the manual path**
...
- [ ] **Scenario: Same-step kickback escalates on the 4th occurrence**
...
- [ ] **Scenario: Per-plan total kickback escalates on the 6th occurrence across different steps**
...
- [ ] **Scenario: Kickback counts survive a process restart**
