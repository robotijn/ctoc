...
description: Ensures naming, patterns, and style consistency across the codebase — catches what formatters can't. Dispatch when the request mentions consistency check, naming convention, style consistency, inconsistent code, naming inconsistency, style guide, formatter drift, or monorepo consistency.
...
type: wrapper
target_skill: quality/consistency-checker
---
