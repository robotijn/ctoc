...
node --test tests/*.test.js          # Run all 314 test files — suite ONLY; does NOT
...
coverage measured 97.2%, SCOPED to `src/**`). The gate scopes coverage with
...
`minPct`, **96** today (measured 97.2% src line coverage, scoped to `src/**`),
