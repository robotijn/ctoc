...
node --test tests/*.test.js          # Run all 309 test files — suite ONLY; does NOT
...
coverage measured 96.91%, SCOPED to `src/**`). The gate scopes coverage with
...
`minPct`, **96** today (measured 96.91% src line coverage, scoped to `src/**`),
