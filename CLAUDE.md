...
node --test tests/*.test.js          # Run all 350 test files — suite ONLY; does NOT
...
coverage measured 98.9%, SCOPED to `src/**`). The gate scopes coverage with
...
`minPct`, **98** today (measured 98.9% src line coverage, scoped to `src/**`),
