...
node --test tests/*.test.js          # Run all 380 test files — suite ONLY; does NOT
...
coverage measured 99.33%, SCOPED to `src/**`). The gate scopes coverage with
...
`minPct`, **99** today (measured 99.33% src line coverage, scoped to `src/**`),
