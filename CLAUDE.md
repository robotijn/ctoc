...
node --test tests/*.test.js          # Run all 334 test files — suite ONLY; does NOT
...
coverage measured 98.17%, SCOPED to `src/**`). The gate scopes coverage with
...
`minPct`, **97** today (measured 98.17% src line coverage, scoped to `src/**`),
