...
node --test tests/*.test.js          # Run all 360 test files — suite ONLY; does NOT
...
coverage measured 99.04%, SCOPED to `src/**`). The gate scopes coverage with
...
`minPct`, **98** today (measured 99.04% src line coverage, scoped to `src/**`),
