...
node --test tests/*.test.js          # Run all 319 test files — suite ONLY; does NOT
...
coverage measured 97.47%, SCOPED to `src/**`). The gate scopes coverage with
...
`minPct`, **97** today (measured 97.47% src line coverage, scoped to `src/**`),
