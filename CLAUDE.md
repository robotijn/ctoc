...
node --test tests/*.test.js          # Run all 355 test files — suite ONLY; does NOT
...
coverage measured 98.97%, SCOPED to `src/**`). The gate scopes coverage with
...
`minPct`, **98** today (measured 98.97% src line coverage, scoped to `src/**`),
