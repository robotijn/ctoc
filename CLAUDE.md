...
node --test tests/*.test.js          # Run all 324 test files — suite ONLY; does NOT
...
coverage measured 97.67%, SCOPED to `src/**`). The gate scopes coverage with
...
`minPct`, **97** today (measured 97.67% src line coverage, scoped to `src/**`),
