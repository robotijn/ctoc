...
describe('Ground truth — project counts (sanity checks)', () => {
  ...
  it('src/lib/: 97 JS modules at top level (streaming-flow + streaming-render + streaming-topics added 2026-07-16)', () => {
    assert.equal(countTopLevelJs('src/lib'), 97);
  });
...
describe('README — explicit numeric claims match reality', () => {
  ...
  it('Project structure: 91 JS modules in src/lib', () => {
    assert.match(README, /97 JS modules/);
  });
