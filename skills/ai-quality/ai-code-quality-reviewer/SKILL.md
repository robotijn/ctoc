...
- **Treat AI suggestions as junior-dev work — assume errors until proven otherwise**. The 2025 Stack Overflow Developer Survey found **66% of developers name "AI solutions that are almost right, but not quite" as their top frustration**, and **45.2% report debugging AI-generated code is more time-consuming**. Tone the review accordingly: skeptical, line-by-line.
