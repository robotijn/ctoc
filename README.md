...
<p align="center">
  ...
  <img alt="Version" src="https://img.shields.io/badge/version-6.14.30-blue">
...
│   ├── hooks/       17 Claude Code hooks (session, user-prompt-submit routing
│   │                reminder, pre/post tool use, andon-halt, subagent concurrency fence)
...
**6.14.30** · Built by [@robotijn](https://github.com/robotijn)
