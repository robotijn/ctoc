...
│   ├── lib/         117 JS modules (planning, quality, refinement, dispatcher, regulatory-regime, compliance-regime, gdpr-helpers, gdpr-agent-runner, audit-chain, retention, legal-hold, traceability, lineage, eval-harness, comparator, stale-detector, stale-cleanup, claude-md-lessons, safe-fs, regex-utils, task-registry, task-view, task-reconcile, operating-manual)
